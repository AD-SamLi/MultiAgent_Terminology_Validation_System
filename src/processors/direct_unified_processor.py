...
if __name__ == "__main__":
    ...
    if os.path.exists(test_input):
        ...
        try:
            ...
            print(f"[FOLDER] Combined: {combined_file}")
            print(f"[FOLDER] Cleaned: {cleaned_file}")
            
            # Show some stats
            cleaned_df = pd.read_csv(cleaned_file)
            print(f"[STATS] Processed {len(cleaned_df)} unique terms")
            print(f"[PERF] Top terms by frequency:")
        ...
        print(f"[WARNING] Test file not found: {test_input}")
