    ...
    if translatability_analysis:
        ...
        if not is_translatable:
            ...
            if has_technical_value:
                ...
                reasons.append(f"[WARNING] UNTRANSLATABLE TERM: {category} - Cannot be translated, no technical value")
        else:
            reasons.append(f"[OK] TRANSLATABLE: {category} - Can be translated")
